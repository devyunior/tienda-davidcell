...
function ProductEdit({ params }) {
  ...
  const uploadHandler = async (e, imageField = 'image') => {
    ...
    try {
      ...
      enqueueSnackbar('El archivo ha subido correctamente', {
        variant: 'éxito',
      });
    } catch (err) {
  ...
  const submitHandler = async ({
    ...
    try {
      ...
      enqueueSnackbar('Producto actualizado con éxito', { variant: 'éxito' });
            ...
            <List>
              <NextLink href="/admin/dashboard" passHref>
                <ListItem button component="a">
                  <ListItemText primary="Panel de administración"></ListItemText>
                </ListItem>
              </NextLink>
              ...
              <NextLink href="/admin/users" passHref>
                <ListItem button component="a">
                  <ListItemText primary="Usuario/as"></ListItemText>
                </ListItem>
              </NextLink>
            </List>
          </Card>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={errors.slug ? 'Se requiere Slug' : ''}
                            {...field}
                          ></TextField>
                        )}
                      ></Controller>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={
                              errors.image ? 'Imagen Se requiere' : ''
                            }
                            {...field}
                          ></TextField>
                        )}
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            helperText={
                              errors.brand ? 'Se requiere la marca' : ''
                            }
                            {...field}
                          ></TextField>
                        )}
