...
export default function ProductScreen(props) {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      setLoading(false);
      enqueueSnackbar('Revisión enviada con éxito', { variant: 'éxito' });
      fetchReviews();
    } catch (err) {
      setLoading(false);
    ...
    <Layout title={product.name}>
      <Box sx={classes.section}>
        <NextLink href="/" passHref>
          <Link>
            <Typography>volver a productos</Typography>
          </Link>
        </NextLink>
      </Box>
        ...
        <Grid item md={3} xs={12}>
          <List>
            ...
            <ListItem>
              ...
              <Link href="#reviews">
                <Typography>({product.numReviews} reseñas)</Typography>
              </Link>
            </ListItem>
            <ListItem>
      ...
      <List>
        ...
        {reviews.length === 0 && <ListItem>Sin revisión</ListItem>}
        {reviews.map((review) => (
        ...
        <ListItem>
          {userInfo ? (
            <Form onSubmit={submitHandler}>
              <List>
                <ListItem>
                  <Typography variant="h2">Deja tu reseña</Typography>
                </ListItem>
                <ListItem>
                  <TextField
                    multiline
